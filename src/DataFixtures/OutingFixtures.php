...
class OutingFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $outing1->setDateTimeStart(new \DateTime('2024-03-30 20:00:00'));
        $outing1->setDuration(120);
        $outing1->setRegistrationDeadline(new \DateTime('2024-03-18'));
        ...
        $outing2->setNbRegistrationMax(5);
        ...
        $outing2->addUser($this->getReference('user_1'));
        $outing2->addUser($this->getReference('user_2'));
        $outing2->addUser($this->getReference('user_3'));
        $outing2->addUser($this->getReference('user_4'));
        $outing2->addUser($this->getReference('user_5'));
        $outing2->setInfoOuting('Venez boire une verre !');
        $manager->persist($outing2);

        $outing3 = new Outing();
        $outing3->setName('Soirée Cinéma');
        $outing3->setDateTimeStart(new \DateTime('2024-03-19 20:00:00'));
        ...
        $outing5->setNbRegistrationMax(8);
